...
**Due date: Tuesday, 24 February 2026, 11:59pm**
...
*Little note for Wordle experts*: We are working with a slight simplification of
the Wordle rules -- in the official rules, if a letter appears multiple times in
a guess, but fewer times in the actual secret word, then the "extra" instances
of that letter are marked as gray in the response! You don't have to worry about
this!
...
The resources you need are available in this directory.
  ...
  * By **Friday, 20 February 2026**, you should have written your `DESIGN.md`,
